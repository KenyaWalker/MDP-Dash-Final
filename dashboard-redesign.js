    ...
    getCohortTableHeaders() {
        return `
            <tr>
                ...
                <th onclick="dashboard.sortTable('evaluators')">Evaluators</th>
    ...
    getCohortTableRows() {
        ...
        return mdpSummaries.map((summary, index) => {
            ...
            <tr class="expandable-row" onclick="dashboard.expandRow('${summary.mdpName}', this)">
                ...
                <td>#${index + 1}</td>
                <td>
                    <small style="color: #555; font-size: 0.9em;">${evaluatorText}</small>
                </td>
                ...
                <div style="padding: 1rem;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin-top: 1rem;">
                        ${mdpData.map(item => `
                            <div style="background: #f8f9fa; padding: 1rem; border-radius: 0.5rem;">
                                <strong>Rotation ${item.rotation} - ${item.functionName}</strong><br>
                                <small style="color: #666;">${item.evaluatorRole}: ${this.formatNameForPrivacy(item.manager)}</small><br><br>
